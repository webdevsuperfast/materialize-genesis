...
?>		
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent card-panel z-depth-1' : 'card-panel z-depth-1' ); ?>>
			<div class="row valign-wrapper">
				<?php if ( 0 != $args['avatar_size'] ): ?>
				<div class="col s2">
					<a href="<?php echo get_comment_author_url(); ?>" class="circle responsive-img">
						<?php echo get_avatar( $comment, $args['avatar_size'] ); ?>
					</a>
				</div>
				<?php endif; ?>

				<div class="col <?php ( 0 != $args['avatar_size'] ) ? 's10' : 's12'; ?>">
